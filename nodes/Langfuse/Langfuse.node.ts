...
const v1Description: NodeDescription = {
  ...
  properties: [
    ...
    { displayName: 'Trace ID', name: 'traceId', type: 'string', default: '', placeholder: '1234567890abcdef1234567890abcdef', description: 'Optional for Trace Create. Leave blank to auto-generate a new trace id.', displayOptions: showIngestionBasic('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    ...
    { displayName: 'User ID', name: 'userId', type: 'string', default: '', description: 'Optional user identifier attached to the trace.', displayOptions: showIngestion('traceCreate') },
    { displayName: 'Session ID', name: 'sessionId', type: 'string', default: '', description: 'Optional session identifier attached to the trace or score.', displayOptions: showIngestion('traceCreate', 'scoreCreate') },
    { displayName: 'Public', name: 'public', type: 'boolean', default: false, description: 'Mark the trace as public in Langfuse.', displayOptions: showIngestion('traceCreate') },
...
const v2Description: NodeDescription = {
  ...
  properties: [
    ...
    { displayName: 'Trace ID', name: 'traceId', type: 'string', default: '', placeholder: '1234567890abcdef1234567890abcdef', description: 'Optional for Trace Create. Leave blank to auto-generate.', displayOptions: v2Basic('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    ...
    { displayName: 'Session ID', name: 'sessionId', type: 'string', default: '', description: 'Optional session identifier attached to the trace or score.', displayOptions: v2Adv('traceCreate', 'scoreCreate') },
    { displayName: 'Public', name: 'public', type: 'boolean', default: false, description: 'Mark the trace as public in Langfuse.', displayOptions: v2Adv('traceCreate') },
