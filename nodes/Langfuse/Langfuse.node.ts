...
const v1Description: NodeDescription = {
  ...
  properties: [
    ...
    { displayName: 'Trace ID', name: 'traceId', type: 'string', default: '={{ $json.traceId }}', placeholder: '1234567890abcdef1234567890abcdef', description: 'Trace this observation or score attaches to. Auto-filled from the previous step traceId output; clear it to start a new trace.', displayOptions: showIngestionBasic('spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    ...
    { displayName: 'Observation ID', name: 'observationId', type: 'string', default: '={{ $json.observationId }}', required: true, placeholder: 'Span to finalize', description: 'The span being finalized. Auto-filled from the previous step observationId output; set it explicitly if the span was created earlier in the flow.', displayOptions: showIngestionBasic('finalizeSpan') },
...
const v2Description: NodeDescription = {
  ...
  properties: [
    ...
    { displayName: 'Observation ID', name: 'observationId', type: 'string', default: '={{ $json.observationId }}', required: true, placeholder: 'Span to finalize', description: 'The span being finalized. Auto-filled from the previous step observationId output; set it explicitly if the span was created earlier in the flow.', displayOptions: v2Basic('finalizeSpan') },
    ...
    { displayName: 'Session ID', name: 'sessionId', type: 'string', default: '', placeholder: 'Defaults to the trace ID', description: 'Session this trace or score belongs to. On Trace Create it defaults to the trace ID; set a value to override or to group several traces under one session.', displayOptions: v2Basic('traceCreate', 'scoreCreate') },
