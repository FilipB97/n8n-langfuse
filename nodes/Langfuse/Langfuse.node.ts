      ...
      if (INGESTION_OPERATIONS.has(operation)) {
        ...
        output.push({
          json: {
            ...
            ...(summary.observationId !== undefined ? { observationId: summary.observationId } : {}),
            ids: summary.ids,
...
const v1Description: NodeDescription = {
  ...
  properties: [
    ...
    { displayName: 'Trace ID', name: 'traceId', type: 'string', default: '', placeholder: '1234567890abcdef1234567890abcdef', description: 'Optional. Leave blank to auto-generate a new trace ID.', displayOptions: showIngestionAdvanced('traceCreate') },
    { displayName: 'Trace ID', name: 'traceId', type: 'string', default: '', placeholder: '1234567890abcdef1234567890abcdef', description: 'Trace this observation or score attaches to. Leave blank to auto-fill from the previous step traceId output; set it explicitly to start or target a specific trace.', displayOptions: showIngestionAdvanced('spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    ...
    { displayName: 'Event ID', name: 'eventId', type: 'string', default: '', placeholder: 'Optional event ID', description: 'Optional event ID for idempotency and deduplication', displayOptions: showIngestionAdvanced('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    { displayName: 'Observation ID', name: 'observationId', type: 'string', default: '', placeholder: 'Optional observation ID', description: 'Required for update operations. Leave blank for create operations to auto-generate an observation ID.', displayOptions: showIngestionAdvanced('spanCreate', 'spanUpdate', 'generationCreate', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    { displayName: 'Observation ID', name: 'observationId', type: 'string', default: '', placeholder: 'Span to finalize', description: 'The span being finalized. Leave blank to auto-fill from the previous step observationId output; set it explicitly if the span was created earlier in the flow.', displayOptions: showIngestionAdvanced('finalizeSpan') },
    { displayName: 'Parent Observation ID', name: 'parentObservationId', type: 'string', default: '', placeholder: 'Optional parent observation ID', description: 'Optional parent observation ID for nested spans, generations, events, and logs', displayOptions: showIngestionAdvanced('spanCreate', 'spanUpdate', 'generationCreate', 'generationUpdate', 'eventCreate', 'sdkLogCreate') },
    { displayName: 'Timestamp', name: 'timestamp', type: 'string', default: '', placeholder: '2026-06-02T10:00:00.000Z', description: 'Optional ISO 8601 timestamp for the event. If blank, the current time is used.', displayOptions: showIngestionAdvanced('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    ...
    { displayName: 'Name', name: 'name', type: 'string', default: '', description: 'Human-readable name for the trace, span, generation, event, or SDK log', displayOptions: showIngestionBasic('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    { displayName: 'User ID', name: 'userId', type: 'string', default: '', description: 'Optional user identifier attached to the trace', displayOptions: showIngestionAdvanced('traceCreate') },
    { displayName: 'Session ID', name: 'sessionId', type: 'string', default: '', placeholder: 'Defaults to the trace ID', description: 'Session this trace or score belongs to. On Trace Create it defaults to the trace ID; set a value to override or to group several traces under one session.', displayOptions: showIngestionAdvanced('traceCreate', 'scoreCreate') },
    ...
    { displayName: 'Environment', name: 'environment', type: 'string', default: '', placeholder: 'production', description: 'Optional environment label for the trace or observation', displayOptions: showIngestion('traceCreate', 'spanCreate', 'generationCreate', 'finalizeSpan', 'eventCreate') },
    { displayName: 'Input JSON', name: 'inputJson', type: 'string', default: '', placeholder: '{"cartId":"cart-1"}', description: 'JSON input payload stored on the trace or observation', displayOptions: showIngestionBasic('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate') },
    { displayName: 'Output JSON', name: 'outputJson', type: 'string', default: '', placeholder: '{"ok":true}', description: 'JSON output payload stored on the trace or observation', displayOptions: showIngestionBasic('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate') },
    { displayName: 'Metadata JSON', name: 'metadataJson', type: 'string', default: '', placeholder: '{"source":"n8n"}', description: 'Additional JSON metadata stored with the trace, observation, score, or SDK log', displayOptions: showIngestion('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    { displayName: 'Version', name: 'version', type: 'string', default: '', description: 'Optional version string stored on the trace or observation', displayOptions: showIngestion('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate') },
    { displayName: 'Level', name: 'level', type: 'string', default: '', placeholder: 'info', description: 'Optional log or observation level', displayOptions: showIngestion('spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate') },
    { displayName: 'Status Message', name: 'statusMessage', type: 'string', default: '', description: 'Optional status message attached to the observation or event', displayOptions: showIngestion('spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate') },
    { displayName: 'Model', name: 'model', type: 'string', default: '', description: 'Model name used for the generation event', displayOptions: showIngestionBasic('generationCreate', 'finalizeSpan', 'generationUpdate') },
    ...
    { displayName: 'Model Parameters JSON', name: 'modelParametersJson', type: 'string', default: '', placeholder: '{"temperature":0.2}', description: 'JSON model parameters stored with the generation', displayOptions: showIngestion('generationCreate', 'finalizeSpan', 'generationUpdate') },
    { displayName: 'Prompt Name', name: 'promptName', type: 'string', default: '', description: 'Prompt name linked to the generation', displayOptions: showIngestionAdvanced('generationCreate', 'generationUpdate', 'finalizeSpan') },
...
const v2Description: NodeDescription = {
  ...
  properties: [
    ...
    { displayName: 'Trace ID', name: 'traceId', type: 'string', default: '', placeholder: '1234567890abcdef1234567890abcdef', description: 'Optional. Leave blank to auto-generate.', displayOptions: v2Adv('traceCreate') },
    { displayName: 'Trace ID', name: 'traceId', type: 'string', default: '', placeholder: '1234567890abcdef1234567890abcdef', description: 'Trace this observation or score attaches to. Leave blank to auto-fill from the previous step traceId output; set it explicitly to start or target a specific trace.', displayOptions: v2Adv('spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    ...
    { displayName: 'Event ID', name: 'eventId', type: 'string', default: '', placeholder: 'Optional event ID', description: 'Optional event ID for idempotency and deduplication', displayOptions: v2Adv('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    { displayName: 'Observation ID', name: 'observationId', type: 'string', default: '', placeholder: 'Optional observation ID', description: 'Required for update operations. Leave blank for create operations to auto-generate.', displayOptions: v2Adv('spanCreate', 'spanUpdate', 'generationCreate', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    { displayName: 'Observation ID', name: 'observationId', type: 'string', default: '', placeholder: 'Span to finalize', description: 'The span being finalized. Leave blank to auto-fill from the previous step observationId output; set it explicitly if the span was created earlier in the flow.', displayOptions: v2Adv('finalizeSpan') },
    { displayName: 'Parent Observation ID', name: 'parentObservationId', type: 'string', default: '', placeholder: 'Optional parent observation ID', description: 'Optional parent observation ID for nested spans, generations, events, and logs', displayOptions: v2Adv('spanCreate', 'spanUpdate', 'generationCreate', 'generationUpdate', 'eventCreate', 'sdkLogCreate') },
    { displayName: 'Timestamp', name: 'timestamp', type: 'string', default: '', placeholder: '2026-06-02T10:00:00.000Z', description: 'Optional ISO 8601 timestamp. If blank, the current time is used.', displayOptions: v2Adv('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    ...
    { displayName: 'Name', name: 'name', type: 'string', default: '', description: 'Human-readable name for the trace, span, generation, event, or SDK log', displayOptions: v2Basic('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    { displayName: 'User ID', name: 'userId', type: 'string', default: '', description: 'Optional user identifier attached to the trace', displayOptions: v2Adv('traceCreate') },
    { displayName: 'Session ID', name: 'sessionId', type: 'string', default: '', placeholder: 'Defaults to the trace ID', description: 'Session this trace or score belongs to. On Trace Create it defaults to the trace ID; set a value to override or to group several traces under one session.', displayOptions: v2Adv('traceCreate', 'scoreCreate') },
    ...
    { displayName: 'Environment', name: 'environment', type: 'string', default: '', placeholder: 'production', description: 'Optional environment label for the trace or observation', displayOptions: v2Adv('traceCreate', 'spanCreate', 'generationCreate', 'finalizeSpan', 'eventCreate') },
    { displayName: 'Input JSON', name: 'inputJson', type: 'string', default: '', placeholder: '{"cartId":"cart-1"}', description: 'JSON input payload stored on the trace or observation', displayOptions: v2Basic('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate') },
    { displayName: 'Output JSON', name: 'outputJson', type: 'string', default: '', placeholder: '{"ok":true}', description: 'JSON output payload stored on the trace or observation', displayOptions: v2Basic('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate') },
    { displayName: 'Metadata JSON', name: 'metadataJson', type: 'string', default: '', placeholder: '{"source":"n8n"}', description: 'Additional JSON metadata stored with the trace, observation, score, or SDK log', displayOptions: v2Adv('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate', 'scoreCreate', 'sdkLogCreate') },
    { displayName: 'Version', name: 'version', type: 'string', default: '', description: 'Optional version string stored on the trace or observation', displayOptions: v2Adv('traceCreate', 'spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate') },
    { displayName: 'Level', name: 'level', type: 'string', default: '', placeholder: 'info', description: 'Optional log or observation level', displayOptions: v2Adv('spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate') },
    { displayName: 'Status Message', name: 'statusMessage', type: 'string', default: '', description: 'Optional status message attached to the observation or event', displayOptions: v2Adv('spanCreate', 'spanUpdate', 'generationCreate', 'finalizeSpan', 'generationUpdate', 'eventCreate') },
    { displayName: 'Model', name: 'model', type: 'string', default: '', description: 'Model name used for the generation', displayOptions: v2Basic('generationCreate', 'finalizeSpan', 'generationUpdate') },
    ...
    { displayName: 'Model Parameters JSON', name: 'modelParametersJson', type: 'string', default: '', placeholder: '{"temperature":0.2}', description: 'JSON model parameters stored with the generation', displayOptions: v2Adv('generationCreate', 'finalizeSpan', 'generationUpdate') },
    { displayName: 'Prompt Name', name: 'promptName', type: 'string', default: '', description: 'Prompt name linked to the generation', displayOptions: v2Adv('generationCreate', 'generationUpdate', 'finalizeSpan') },
    ...
    { displayName: 'Prompt Version', name: 'promptVersion', type: 'string', default: '', description: 'Optional prompt version linked to the generation', displayOptions: v2Adv('generationCreate', 'generationUpdate', 'finalizeSpan') },
